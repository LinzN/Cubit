...
public class RemoveTorchUniversal implements ICommand {
    ...
    public RemoveTorchUniversal(CubitBukkitPlugin plugin, String permNode, CubitType type, boolean isAdmin) {
        this.plugin = plugin;
